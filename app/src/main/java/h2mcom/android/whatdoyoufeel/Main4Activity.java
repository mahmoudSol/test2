...
public class Main4Activity extends AppCompatActivity {
    ...
    String Responseurl = "https://api.openweathermap.org/data/2.5/forecast?id=2643743&units=metric&appid=ee3ecd0b86b1ff088bd6cb62864b2ec3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listViewOfMoscow = (ListView)findViewById( R.id.show_forecasting_for_London );
